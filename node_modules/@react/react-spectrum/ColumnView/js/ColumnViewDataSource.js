...
function () {
  function ItemNode(item, parent, hasChildren, index) {
    (0, _classCallCheck2["default"])(this, ItemNode);
  ...
  (0, _createClass2["default"])(ItemNode, [{
    key: "getItemId",
...
function (_EventEmitter) {
  (0, _inherits2["default"])(ColumnViewDataSource, _EventEmitter);

  function ColumnViewDataSource(dataSource) {
    var _this;

    (0, _classCallCheck2["default"])(this, ColumnViewDataSource);
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ColumnViewDataSource).call(this));
  ...
  (0, _createClass2["default"])(ColumnViewDataSource, [{
    key: "teardown",
    ...
    key: "navigateToItem",
    value: function () {
      var _navigateToItem = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    value: function () {
      var _navigateToPrevious = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    key: "navigateToNext",
    value: function () {
      var _navigateToNext = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    value: function () {
      var _setNavigatedPath = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee5(navigationPath) {
    ...
    value: function replaceSelection(items) {
      // Unselect everything that was selected before, but is not in items
      var difference = (0, _toConsumableArray2["default"])(this.selectedItems).filter(function (x) {
        return items.indexOf(x) === -1;
      });
      this.setSelected(difference, false, false); // Select everything in items
