...
function (_React$Component) {
  ...
  function Slider(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "findNearestHandle", function (pageX, pageY) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onMouseDown", function (e, sliderHandle) {
      if (!sliderHandle) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "calculateHandlePosition", function (e) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getHandleValues", function (value, step) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onMouseMove", function (e) {
      ...
      if (_this.props.variant === 'range') {
        var _this$getHandleValues = _this.getHandleValues(value, _this.props.step),
            _this$getHandleValues2 = (0, _slicedToArray2["default"])(_this$getHandleValues, 2),
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "updateValues", function (startValue) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onChange", function (e, sliderHandle) {
        ...
        if (variant === 'range') {
          _this.setState({
            ...
            var _this$getHandleValues3 = _this.getHandleValues(inputValue, step),
                _this$getHandleValues4 = (0, _slicedToArray2["default"])(_this$getHandleValues3, 2),
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onFocus", function (e, sliderHandle) {
      _this.setState({
        focusedHandle: !_this.state.isMouseUp ? sliderHandle : null,
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onBlur", function (e, sliderHandle) {
      _this.setState({
        focusedHandle: null
      });
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onClickSliderValue", function (e) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getAriaLabelledby", function () {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderSliderHandle", function (sliderHandle) {
      ...
      return _react["default"].createElement("div", {
        ...
        style: (0, _defineProperty2["default"])({}, styleKey, percent * 100 + '%'),
        role: "presentation"
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setDOMReference", function (d) {
      return _this.dom = d;
    });
  ...
  (0, _createClass2["default"])(Slider, [{
    ...
    value: function render() {
      ...
      var _this$props6 = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2["default"])(_this$props6, ["children", "disabled", "filled", "fillOffset", "id", "label", "max", "min", "orientation", "renderLabel", "variant", "aria-label", "getAriaValueText"]);
      ...
      _react["default"].createElement("div", {
        ...
        role: "presentation",
        style: (0, _defineProperty2["default"])({}, styleKeyFill, (isRange ? startPercent : percent) * 100 + '%')
      }), isRamp && _react["default"].createElement("div", {
        ...
        className: "spectrum-Slider-track",
        role: "presentation",
        style: (_ref3 = {}, (0, _defineProperty2["default"])(_ref3, styleKeyOffset, startPercent * 100 + '%'), (0, _defineProperty2["default"])(_ref3, styleKeyOppositeOffset, (1 - endPercent) * 100 + '%'), _ref3)
      }), isRange ? this.renderSliderHandle('endHandle') : null, !isRamp && _react["default"].createElement("div", {
        className: "spectrum-Slider-track",
        role: "presentation",
        style: (0, _defineProperty2["default"])({}, styleKeyFill, (1 - (isRange ? endPercent : percent)) * 100 + '%')
        ...
        role: "presentation",
        style: (_ref5 = {}, (0, _defineProperty2["default"])(_ref5, styleKeyOffset, minFillPercent * 100 + '%'), (0, _defineProperty2["default"])(_ref5, styleKeyFill, (maxFillPercent - minFillPercent) * 100 + '%'), _ref5)
      }) : null));
    }
  }]);
  return Slider;
