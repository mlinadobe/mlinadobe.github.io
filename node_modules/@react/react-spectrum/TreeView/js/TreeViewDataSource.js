...
function (_ArrayDataSource) {
  (0, _inherits2["default"])(TreeViewDataSource, _ArrayDataSource);

  function TreeViewDataSource(dataSource) {
    var _this;

    (0, _classCallCheck2["default"])(this, TreeViewDataSource);
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(TreeViewDataSource).call(this, [[]]));
    ...
    if (dataSource && typeof dataSource.on === 'function') {
      ...
      _this.startTransaction = _this.startTransaction.bind((0, _assertThisInitialized2["default"])(_this));
      _this.endTransaction = _this.endTransaction.bind((0, _assertThisInitialized2["default"])(_this));
      _this.insertChild = _this.insertChild.bind((0, _assertThisInitialized2["default"])(_this));
      _this.removeItem = _this.removeItem.bind((0, _assertThisInitialized2["default"])(_this));
      _this.moveItem = _this.moveItem.bind((0, _assertThisInitialized2["default"])(_this));
      _this.reloadItem = _this.reloadItem.bind((0, _assertThisInitialized2["default"])(_this)); // Setup event handlers
  ...
  (0, _createClass2["default"])(TreeViewDataSource, [{
    key: "teardown",
    ...
    key: "loadChildren",
    value: function () {
      var _loadChildren = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee2(parent) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee3(parent) {
    ...
    key: "toggleItem",
    value: function () {
      var _toggleItem = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    key: "expandItem",
    value: function () {
      var _expandItem = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee5(item) {
        var _this2 = this;
    ...
    value: function collapseItem(item) {
      ...
      node.walk(function (child) {
        if (child.isVisible) {
          ...
          (0, _get2["default"])((0, _getPrototypeOf2["default"])(TreeViewDataSource.prototype), "removeItem", _this3).call(_this3, indexPath);
        }
      });
      this.endTransaction(showAnimation);
    }
    ...
    value: function removeChild(parent, index) {
      ...
      if (parentItem.isExpanded) {
        ...
        child.isVisible = false;
        (0, _get2["default"])((0, _getPrototypeOf2["default"])(TreeViewDataSource.prototype), "removeItem", this).call(this, indexPath); // Remove all children

        if (child.isExpanded) {
          child.walk(function (child) {
            child.isVisible = false;
            (0, _get2["default"])((0, _getPrototypeOf2["default"])(TreeViewDataSource.prototype), "removeItem", _this4).call(_this4, indexPath);
          });
        }
    ...
    value: function moveChild(fromParent, fromIndex, toParent, toIndex) {
      ...
      if (fromItem.isExpanded && toItem.isExpanded) {
        ...
        (0, _get2["default"])((0, _getPrototypeOf2["default"])(TreeViewDataSource.prototype), "moveItem", this).call(this, fromVisibleIndex, toVisibleIndex);
      } else if (fromItem.isExpanded) {
        child.isVisible = false;
        (0, _get2["default"])((0, _getPrototypeOf2["default"])(TreeViewDataSource.prototype), "removeItem", this).call(this, fromVisibleIndex);
